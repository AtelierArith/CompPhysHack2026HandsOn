...
TODO マンデルブロー集合のデモのスクリーンショットを置く
...
- [RustCall.jl](https://github.com/AtelierArith/RustCall.jl)
...
TODO: ここに AI による開発をしている様子の挿絵を追加
...
::: {.fragment}
親愛なる科学者の皆様，科学技術計算には Julia または Rust を使いましょう．
...
::: {.fragment}
tensor4all-rs は科学技術計算のために Rust を採用した非常に良い例となるでしょう．
:::
